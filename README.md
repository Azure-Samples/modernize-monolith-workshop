...
In this full-day workshop, you'll take a legacy [.NET Framework](https://docs.microsoft.com/en-us/dotnet/framework/) monolith and modernize it to the latest [.NET](https://docs.microsoft.com/en-us/dotnet/) release using AI-powered tooling and the [GitHub Copilot Modernization](https://learn.microsoft.com/en-us/dotnet/core/porting/github-copilot-app-modernization-overview) tool. You'll learn how to layer in cloud-native capabilities with [Aspire](https://learn.microsoft.com/en-us/dotnet/aspire/) for service discovery, telemetry, and orchestration, containerize the app, and deploy it to [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) using the Aspire CLI. Along the way, you'll even explore how to integrate [Azure AI services](https://docs.microsoft.com/en-us/azure/cognitive-services/) to enhance your application with intelligent capabilities, culminating in a modernized microservices solution built for scale and agility.
...
This workshop is split into 9 different parts. Each shows you an aspect of modernizing your app. The sections each have their own learning materials and hands-on exercises in sub-folders.

1. [🔧 Setup your environment](./1-setup-your-environment/README.md)
2. [🔄 Upgrade .NET Applications](./2-upgrade-dotnet/2-upgrade-with-ghcp-modernization-app/README.md)
...
5. [⭐ Add Aspire (service discovery, dashboard / telemetry)](./5-add-dotnet-aspire/README.md)
6. [🚀 Add additional Redis for caching (add to Aspire)](./6-add-redis-caching/README.md)
7. [☁️ Deploy to Azure Container Apps with Aspire CLI](./7-deploy-to-aca/README.md)
8. [🧠 Add in some AI](./8-add-ai-capabilities/README.md)
9. [🖥️ Migrate a WinForms Application (Optional Capstone)](./9-migrate-winforms/README.md)
...
🎥 [Elevating Development with Aspire: AI, Cloud, and Beyond](https://build.microsoft.com/en-US/sessions/BRK106?source=sessions)  
...
📖 [GitHub Copilot Modernization Overview](https://learn.microsoft.com/en-us/dotnet/core/porting/github-copilot-app-modernization-overview)  
